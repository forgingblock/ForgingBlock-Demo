        ...
        <mu-row gutter>
            <mu-col sm="12" md="6">
                <mu-paper style="padding: 15px;" class="demo-paper" :z-depth="1">
                    <mu-container>
                        <h2 style="">New invoice</h2>
                        <mu-form :model="form" class="mu-demo-form" :label-position="labelPosition" label-width="100">
                            <mu-form-item prop="input" label="Amount">
                                <mu-text-field v-model="form.input"></mu-text-field>
                            </mu-form-item>
                            <mu-form-item prop="select" label="Select store">
                                <mu-select v-model="form.select">
                                    <mu-option v-for="option,index in options" :key="option" :label="option" :value="option"></mu-option>
                                </mu-select>
                            </mu-form-item>
                            <mu-form-item prop="input" label="Link">
                                <mu-text-field v-model="form.input"></mu-text-field>
                            </mu-form-item>
                            <mu-form-item prop="input" label="Notification">
                                <mu-text-field v-model="form.input"></mu-text-field>
                            </mu-form-item>
                            <mu-form-item prop="input" label="Order ID">
                                <mu-text-field v-model="form.input"></mu-text-field>
                            </mu-form-item>
                            <mu-form-item>
                                <mu-button color="primary" @click="submit">create invoice</mu-button>
