        ...
        <mu-paper align-items justify-content :z-depth="1" class="demo-list-wrap">
            <mu-list>
                <mu-list-item avatar button :ripple="false">
                    ...
                    <mu-list-item-title>Bitcoin</mu-list-item-title>
                    <mu-list-item-action>
                        <mu-button small disabled color="primary">wallet</mu-button>
                    </mu-list-item-action>
                </mu-list-item>
                ...
                <mu-list-item avatar button :ripple="false">
                    ...
                    <mu-list-item-title>Bitcoin Cash</mu-list-item-title>
                    <mu-list-item-action>
                        <mu-button small color="primary">Connect wallet</mu-button>
                    </mu-list-item-action>
                </mu-list-item>
                <mu-divider></mu-divider>
                <mu-list-item avatar button :ripple="false">
                    ...
                    <mu-list-item-title>Ethereum</mu-list-item-title>
                    <mu-list-item-action>
                        <mu-button small disabled color="primary">wallet</mu-button>
                    </mu-list-item-action>
                </mu-list-item>
                ...
                <mu-list-item avatar button :ripple="false">
                    ...
                    <mu-list-item-title>Litecoin</mu-list-item-title>
                    <mu-list-item-action>
                        <mu-button small disabled color="primary">wallet</mu-button>
                    </mu-list-item-action>
                </mu-list-item>
